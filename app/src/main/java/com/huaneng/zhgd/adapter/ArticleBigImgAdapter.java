 ...
 * 文章Adapter-大图
 */
public class ArticleBigImgAdapter extends BaseAdapter {

    private Context mContext;

    private List<Article> articles = null;

    public ArticleBigImgAdapter(Context context, List<Article> articles) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_article_big_img, null);
